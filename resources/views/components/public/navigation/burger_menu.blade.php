...
<div class="{!! $name_parent !!}__burger">
    ...
    <label class="{!! $name_parent !!}__burger__label nav__toggle" aria-label="Ouvrir le menu principal" for="menu-toggle">
    ...
    <x-public.navigation.list.list-burger name_parent="{!! $name_parent !!}__burger__container" li_class="burger_link"/>
</div>
