            ...
            <form class="formContainer__form" wire:submit.prevent="store()" enctype="multipart/form-data" method="post">
                ...
                <div class="formContainer__form__secondary">
                    <fieldset class="formContainer__form__secondary__fieldset">
                        ...
                        <x-user.form.fields.textarea wire:model.live="form.description" name_parent="formContainer__form__secondary__fieldset" field_name="post_description" placeholder="Décrivez l’état de votre matériel, son utilisation ou toutes autres informations utiles" label="Description"/>
