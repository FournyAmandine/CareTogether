...
Route::livewire('/admin/dashboard', 'pages::admin.dashboard')->name('admin.dashboard')->middleware('auth', IsAdministrator::class);
...
Route::livewire('/user/messages{conversation?}', 'pages::user.messages')->name('user.messages')->middleware('auth', IsUser::class);
